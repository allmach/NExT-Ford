...
from challenge1.ext.models import Product, Client
...
class ProductListAPI(Resource):
    def __init__(self):
        ...
        self.reqparse.add_argument('title', required=False, type=str,
                                   help='mande algum nome')
        self.reqparse.add_argument('price', required=False, type=int,
                                   help='mande algum preço', default=0.0)
        self.reqparse.add_argument('zipcode', required=False, type=str,
                                   help='mande algum nome')
        self.reqparse.add_argument('seller', required=False, type=str,
                                   help='mande algum nome')
        self.reqparse.add_argument('thumbnailHd', required=False, type=str,
                                   help='mande algum nome') 
    ...
    def post(self):
        ...
        product = Product(title=args.title, price=args.price,
                          zipcode=args.zipcode, seller=args.seller,thumbnailHd=args.thumbnailHd, date=args.date)
